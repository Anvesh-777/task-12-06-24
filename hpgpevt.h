...
//    EVENT_TYPE_TIMER_TEI_IND,
    ...
    EVENT_TYPE_SET_SEC_MODE,	/*Frame Receive Interrupt*/
	EVENT_TYPE_FRAME_RX,
#ifdef POWERSAVE
	/* Power Save events */
    ...
    EVENT_TYPE_TIMER_WDT_SET_IND, 
    EVENT_TYPE_TIMER_SPI_TRAIN_IND,     
#ifdef SW_RECOVERY	
    EVENT_TYPE_TIMER_DISC_STALL_IND,
	EVENT_TYPE_TIMER_BCN_STALL_IND,
#endif
	EVENT_TYPE_TIMER_JOIN_TIMEOUT,

#ifdef KEEP_ALIVE    
    EVENT_TYPE_TIMER_KEEP_LIVE_IND,
#endif 
    EVENT_TYPE_TIMER_CCO_BBT_IND,
#if 1 //def AC_TO_DC
    EVENT_TYPE_TIMER_AC_DC_IND,
#endif
	EVENT_TYPE_TIMER_SCAN_TIMEOUT_IND,
	EVENT_TYPE_JOINNET_TIMEOUT,
};
...
#ifdef KEEP_ALIVE
#define    EVENT_TYPE_VENDOR_KEEP_ALIVE_IND MMTYPE_VENDOR_KEEP_ALIVE_IND
#endif
 ...
 *
 * $Log: hpgpevt.h,v $
 * Revision 1.16  2015/01/02 14:55:35  kiran
 ...
 *
 * Revision 1.15  2014/12/09 07:09:08  ranjan
